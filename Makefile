...
compose-up: docker
	...
	docker exec -it vcb_ingest_1 /bin/sh -c 'ingest 10E 2ED 3ED 4ED 5DN 5ED 6ED 7ED 8ED 9ED A25 AER AKH ALA ALL APC ARB ARC ARN ATH ATQ AVR BBD BFZ BNG BOK C13 C14 C15 C16 C17 C18 CHK CHR CM2 CMA CMD CN2 CNS CON CSP DD2 DDC DDD DDE DDF DDG DDN DDO DDP DDQ DDR DDS DDT DDU DGM DIS DKA DOM DRK DST DTK E01 E02 ELD EMA EMN EVE EXO EXP FEM FRF FUT GK1 GK2 GNT GPT GRN GTC HML HOU ICE IMA INV ISD JOU JUD KLD KTK LEA LEB LEG LGN LRW M10 M11 M12 M13 M14 M15 M19 M20 MBS MED MH1 MIR MM2 MM3 MMA MMQ MOR MPS MRD NEM NPH ODY OGW ONS ORI PC2 PCA PCY PLC PLS RAV RIX RNA ROE RTR SCG SHM SOI SOK SOM STH THS TMP TOR TSP UDS ULG UMA USG VIS W16 WAR WTH WWK XLN ZEN C19 ELD TBD IKO'
	docker exec -it vcb_api_1 /cardboard rescry -r /cache -c /data/cards.json -p /data/prices.json -l /data/lookup.json
